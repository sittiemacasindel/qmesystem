        ...
        Column(
            ...
            QmePrimaryButton(
                ...
                onClick = {
                    loading = true
                    errorMsg = null
                    viewModel.register(name, email, password, confirmPassword) { success, msg ->
                        loading = false
                        if (success) onRegisterSuccess() else errorMsg = msg
                    }
                },
                loading = loading
            )
            ...
            Row(
                ...
                Text(
                    ...
                    fontSize = 13.sp,
                    modifier = Modifier.clickable(enabled = !loading) { onNavigateToLogin() }
                )
            }
